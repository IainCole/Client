...
#include "ui_RundownAtemKeyerInputWidget.h"
...
class WIDGETS_EXPORT RundownAtemKeyerInputWidget : public QWidget, Ui::RundownAtemKeyerInputWidget, public AbstractRundownWidget, public AbstractPlayoutCommand
{
    Q_OBJECT

    public:
        explicit RundownAtemKeyerInputWidget(const LibraryModel& model, QWidget* parent = 0, const QString& color = Color::DEFAULT_TRANSPARENT_COLOR,
